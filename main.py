...
async def cmd_start(message: Message):
    ...
    await message.answer(
        ...
        "📋 <b>راهنمای دستورها:</b>\n\n"
        "🟢 <b>سیگنال جدید</b>\n"
        "/new_signal — ثبت دستی یک سیگنال جدید\n\n"
        "📊 <b>مدیریت سیگنال‌های فعال</b>\n"
        "/list_active — نمایش سیگنال‌های فعال\n"
        "/force_complete PAIR — بستن دستی یک سیگنال فعال (مثلاً /force_complete BTC/USDT)\n\n"
        "🗂 <b>مدیریت صف انتظار</b>\n"
        "/clear_queue — خالی‌کردن کل صف انتظار\n"
        "/manage_queue — انتخاب و حذف تک‌تک از صف با دکمه\n\n"
        "💾 <b>پشتیبان‌گیری</b>\n"
        "/backup — گرفتن فایل پشتیبان از سیگنال‌ها و تاریخچه\n"
        "/restore — شروع بازگردانی از فایل پشتیبان\n"
        "/done_restore — پایان‌دادن به فرآیند بازگردانی\n\n"
        "🤖 <b>کنترل یوزربات رله سیگنال</b>\n"
        "/pause_relay — متوقف‌کردن یوزربات\n"
        "/resume_relay — فعال‌کردن دوباره یوزربات\n"
        "/relay_status — وضعیت فعلی یوزربات",
        parse_mode="HTML",
    )
